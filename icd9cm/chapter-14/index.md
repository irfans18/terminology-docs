...
#### 76.43 Other reconstruction of mandible {#76-43}
  - _Excludes:_ genioplasty ([76.67-76.68](#76-67))
...
- synthetic implant ([76.92](#76-92))
  - _Excludes:_ reconstruction of facial bones ([76.41-76.46](#76-41))
...
- [0-9]
  - _Excludes:_ that for hallux valgus ([77.51](#77-51))
...
- _Includes:_ application of cast or splint reduction with insertion of traction device (Kirschner wire)
  - (Steinmann pin)
  - Code also any:
...
- [0-9]
  - _Excludes:_ that for separation of epiphysis ([79.50-79.59](#79-50))
...
- _Includes:_ open reduction (with internal and external fixation devices)
- _Excludes:_ open reduction of dislocation of temporomandibular joint ([76.94](#76-94))
...
- [0-9]
  - _Includes:_ removal of posterior spinal motion preservation (dynamic stabilization, f acet
  ...
  - _Excludes:_ removal of pedicle screws used in spinal fusion ([78.69](#78-6))
...
#### 80.53 Repair of the anulus f ibrosus with graf t or prosthesis {#80-53}
  ...
  - _Includes:_ microsurgical suture repair with f ascial autograf t
...
- Complete or partial resection of synovial membrane
  - _Excludes:_ excision of Baker's cyst ([83.39](#83-39))
...
- [0-9]
  - _Excludes:_ cheilectomy of joint ([77.80-77.89](#77-80))
...
- posterior, posterolateral, or lateral transverse technique.
  ...
  - _Excludes:_ correction of pseudarthrosis of spine ([81.30-81.39](#81-30))
...
- _Includes:_ arthrodesis of foot and ankle with:
  - bone graft
...
- _Includes:_ arthroplasty of lower extremity with:
...
#### 81.65 Percutaneous vertebroplasty {#81-65}
  ...
  - vertebral body
  - _Excludes:_ percutaneous vertebral augmentation ([81.66](#81-66))
#### 81.66 Percutaneous vertebral augmentation {#81-66}
  ...
  - SKyphoplasty
  - Spineoplasty
  - _Excludes:_ percutaneous vertebroplasty ([81.65](#81-65))

### 81.7 Arthroplasty and repair of hand, fingers and wrist {#81-7}

- _Includes:_ arthroplasty of hand and finger with:
  - external traction or fixation
  - graft of bone (chips) or cartilage
  - internal fixation device or prosthesis
- _Excludes:_ operations on muscle, tendon and fascia of hand ([82.01-82.99](#82-01))
...
- _Includes:_ arthroplasty of upper limb NEC with:
  - external traction or fixation
  - graft of bone (chips) or cartilage
  - internal fixation device or prosthesis
#### 81.80 Other total shoulder replacement {#81-80}
  - _Excludes:_ reverse total shoulder replacement ([81.88](#81-88))
...
#### 81.88 Reverse total shoulder replacement {#81-88}
  ...
  - _Excludes:_ conversion of prior (failed) total shoulder replacement (arthroplasty) to reverse total
...
#### 82.01 Exploration of tendon sheath of hand {#82-01}
  ...
  - _Excludes:_ division of tendon ([82.11](#82-11))
#### 82.02 Myotomy of hand {#82-02}
  - _Excludes:_ myotomy for division ([82.19](#82-19))
...
#### 82.33 Other tenonectomy of hand {#82-33}
  ...
  - _Excludes:_ excision of lesion of:
    - tendon ([82.29](#82-29))
    - sheath ([82.21](#82-21))
...
#### 82.35 Other fasciectomy of hand {#82-35}
  ...
  - _Excludes:_ excision of lesion of fascia ([82.29](#82-29))
...
#### 82.44 Other suture of flexor tendon of hand {#82-44}
  - _Excludes:_ delayed suture of flexor tendon of hand ([82.42](#82-42))
#### 82.45 Other suture of other tendon of hand {#82-45}
  - _Excludes:_ delayed suture of other tendon of hand ([82.43](#82-43))
...
#### 82.56 Other hand tendon transfer or transplantation {#82-56}
  - _Excludes:_ pollicization of thumb ([82.61](#82-61))
...
#### 82.89 Other plastic operations on hand {#82-89}
  ...
  - _Excludes:_ that with graft or implant ([82.71-82.79](#82-71))
...
- _Excludes:_ biopsy of soft tissue ([83.21](#83-21))
...
#### 83.64 Other suture of tendon {#83-64}
  - Achillorrhaphy
  - Aponeurorrhaphy
  - _Excludes:_ delayed suture of tendon ([83.62](#83-62))
#### 83.65 Other suture of muscle or fascia {#83-65}
  - Repair of diastasis recti

### 83.7 Reconstruction of muscle and tendon {#83-7}

- _Excludes:_ reconstruction of muscle and tendon associated with arthroplasty
...
- _Excludes:_ plastic operations on muscle, tendon, and fascia associated with arthroplasty
...
#### 84.55 Insertion of bone void f iller {#84-55}
  ...
  - _Excludes:_ that with percutaneous vertebral augmentation ([81.66](#81-66))
...
#### 84.59 Insertion of other spinal devices {#84-59}
  - _Excludes:_ initial insertion of pedicle screws with spinal fusion-omit code
...
#### 84.72 Application of external fixator device, ring system {#84-72}
  - Ilizarov type
  - Sheffield type
  - _Excludes:_ monoplanar device or system ([84.71](#84-71))
...
#### 84.73 Application of hybrid external fixator device {#84-73}
  ...
  - _Excludes:_ monoplanar device or system, when used alone ([84.71](#84-71))
...
#### 84.80 Insertion or replacement of interspinous process device(s) {#84-80}
  ...
  - _Excludes:_ insertion or replacement of facet replacement device ([84.84](#84-84))
...
#### 84.81 Revision of interspinous process device(s) {#84-81}
  ...
  - _Excludes:_ revision of facet replacement device(s) ([84.85](#84-85))
...
#### 84.82 Insertion or replacement of pedicle-based dynamic stabilization device(s) {#84-82}
  - _Excludes:_ initial insertion of pedicle screws with spinal fusion - omit code
    ...
    - replacement of pedicle screws used in spinal fusion ([78.59](#78-5))
