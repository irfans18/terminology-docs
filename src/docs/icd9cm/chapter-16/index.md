...
- _Excludes:_ angiography ([88.40-88.68](#88-40))
...
- **87.09** Other soft tissue x-ray of face, head, and neck {#87-09}
  ...
  - thyroid region
  - uvula
  - _Excludes:_ x-ray study of eye ([95.14](#95-14))
...
- _Excludes:_ angiocardiography ([88.50-88.58](#88-50))
...
- **87.42** Other tomography of thorax {#87-42}
  - Cardiac tomogram
  - _Excludes:_ C.A.T. scan of heart ([87.41](#87-41))
...
- _Excludes:_ angiography of renal vessels (88.45, 88.65)
...
- **88.01** Computerized axial tomography of abdomen {#88-01}
  ...
  - _Excludes:_ C.A.T. scan of kidney ([87.71](#87-71))
- **88.02** Other abdomen tomography {#88-02}
  - _Excludes:_ nephrotomogram ([87.72](#87-72))
...
- _Excludes:_ contrast radiogram of joint ([88.32](#88-32))
...
- **88.32** Contrast arthrogram {#88-32}
  - _Excludes:_ that of temporomandibular joint ([87.13](#87-13))
- **88.33** Other skeletal x-ray {#88-33}
  - _Excludes:_ skeletal x-ray of:
...
- **88.37** Other soft tissue x-ray of lower limb {#88-37}
  - _Excludes:_ femoral angiography (88.48, 88.66)
...
- _Includes:_ angiography of arteries
...
- _Excludes:_ arteriography using:
...
- **88.52** Angiocardiography of right heart structures {#88-52}
  ...
  - _Excludes:_ intra-operative fluorescence vascular angiography ([88.59](#88-59))
...
- _Includes:_ angiography of veins
...
- _Excludes:_ psychiatric diagnostic interview ([94.11-94.19](#94-11))
...
- organs
  - _Excludes:_ ear examination ([95.41-95.49](#95-41))
...
- **89.14** Electroencephalogram {#89-14}
  - _Excludes:_ that with polysomnogram ([89.17](#89-17))
...
- _Excludes:_ the listed procedures when done as part of a general physical examination (89.7)
...
- 89.391 Exhaled substance breath test (IM)
  - _Excludes:_ body measurement ([93.07](#93-07))
...
- **89.54** Electrographic monitoring {#89-54}
  - Telemetry
  - _Excludes:_ ambulatory cardiac monitoring ([89.50](#89-50))
...
- **89.65** Measurement of systemic arterial blood gases {#89-65}
  - _Excludes:_ continuous intra-arterial blood gas monitoring ([89.60](#89-60))
...
The following fourth-digit subclassification is for use with categories in section 90 to identify type of examination:
...
- 9 other microscopic examination
  ...
  - 99 Other Microscopic examination (IM)
...
- 90.043 Microscopic examination of specimen from nervous system and of spinal fluid, Fungal culture mold and susceptibility test (IM)
- 90.049 Microscopic examination of specimen from nervous system and of spinal fluid, Parasitology smear (IM)
...
- 90.061 Microscopic examination of specimen from nervous system and of spinal fluid, papanicolaou and giemsa smear (IM)
- 90.069 Microscopic examination of specimen from nervous system and of spinal fluid, other cell block and papanicolaou smear (IM)
- 90.07 Microscopic examination of specimen from nervous system and of spinal fluid, Molecular biological test (IM) or Cythopathologic (IM)
- 90.090 Microscopic examination of specimen from nervous system and of spinal fluid, Microscopic ISH examination (IM)
- 90.091 Microscopic examination of specimen from nervous system and of spinal fluid, Microscopic CISH examination (IM)
- 90.092 Microscopic examination of specimen from nervous system and of spinal fluid, Microscopic FISH examination (IM)
...
- 90.098 Microscopic examination of specimen from nervous system and of spinal fluid, Other specified microscopic examinations (IM)
- 90.099 Microscopic examination of specimen from nervous system and of spinal fluid, Other Microscopic examination (IM)
...
## 91 Microscopic examination-II {#91-ii}

The following fourth-digit subclassification is for use with categories in section 91 to identify type of examination:
...
- nails
- skin
  - _Excludes:_ mucous membrane -- code to organ site
...
- **92.20** Inf usion of liquid brachytherapy radioisotope {#92-20}
  ...
  - _Includes:_ removal of radioisotope
...
- **92.25** Teleradiotherapy using electrons {#92-25}
  ...
  - _Excludes:_ intra-operative electron radiation therapy ([92.41](#92-41))
...
- Code also stereotactic head f rame application ([93.59](#93-59))
  - _Excludes:_ stereotactic biopsy
...
- **93.08** Electromyography {#93-08}
  - _Excludes:_ eye EMG ([95.25](#95-25))
...
- **93.11** Assisting exercise {#93-11}
  - _Excludes:_ assisted exercise in pool ([93.31](#93-31))
...
- **93.21** Manual and mechanical traction {#93-21}
  - _Excludes:_ skeletal traction ([93.43-93.44](#93-43))
...
- **93.35** Other heat therapy {#93-35}
  ...
  - Moxibustion
  - Paraffin bath
  - _Excludes:_ hyperthermia for treatment of cancer ([99.85](#99-85))
...
- **93.54** Application of splint {#93-54}
  - Plaster splint
  - Tray splint
  - _Excludes:_ periodontal splint (24.7)
- **93.55** Dental wiring {#93-55}
  - _Excludes:_ that for orthodontia (24.7)
...
- **93.81** Recreation therapy {#93-81}
  - Diversional therapy
  - Play therapy
  - _Excludes:_ play psychotherapy ([94.36](#94-36))
...
- **93.83** Occupational therapy {#93-83}
  ...
  - _Excludes:_ training in activities of daily living for the blind ([93.78](#93-78))
...
- _Excludes:_ insertion of airway ([96.01-96.05](#96-01))
...
- **93.90** Non-invasive mechanical ventilation {#93-90}
  ...
  - oral mouthpiece
  - oronasal mask
  - _Excludes:_ invasive (through endotracheal tube or tracheostomy) continuous mechanical
    - ventilation ([96.70-96.72](#96-70))
...
- **96.05** Other intubation of respiratory tract {#96-05}
  - _Excludes:_ endoscopic insertion or replacement of bronchial device or substance (33.71, 33.79)
...
- **96.07** Insertion of other (naso-)gastric tube {#96-07}
  ...
  - _Excludes:_ that for enteral infusion of nutritional substance (96.6)
...
- **96.39** Other transanal enema {#96-39}
  - Rectal irrigation
  - _Excludes:_ reduction of intussusception of alimentary tract by ionizing radiation enema ([96.29](#96-29))
...
- **96.51** Irrigation of eye {#96-51}
  ...
  - _Excludes:_ irrigation with removal of foreign body ([98.21](#98-21))
...
- **96.59** Other irrigation of wound {#96-59}
  - Wound cleaning NOS
  - _Excludes:_ debridement (86.22, 86.27-86.28)
...
- _Excludes:_ non-invasive bi-level positive airway pressure [BiPAP] ([93.90](#93-90))
...
- _Excludes:_ removal of therapeutic device (97.31-97.49, 97.61-97.89)
...
- **99.09** Transf usion of other substance {#99-09}
  ...
  - blood surrogate
  - granulocytes
  - _Excludes:_ transplantation [transfusion] of bone marrow (41.0)
...
- **99.37** Vaccination against pertussis {#99-37}
  - _Excludes:_ administration of diphtheria tetanus-pertussis, combined ([99.39](#99-39))
...
- **99.45** Vaccination against measles {#99-45}
  - _Excludes:_ administration of measles-mumps rubella vaccine ([99.48](#99-48))
...
- **99.71** Therapeutic plasmapheresis {#99-71}
  - _Excludes:_ extracorporeal immunoadsorption [ECI] 99.76
...
- **99.83** Other phototherapy {#99-83}
  ...
  - _Excludes:_ extracorporeal photochemotherap ([99.88](#99-88))
...
- **99.88** Therapeutic photopheresis {#99-88}
  ...
  - _Excludes:_ other phototherapy ([99.83](#99-83))
...
- **99.92** Other acupuncture {#99-92}
  - _Excludes:_ that with smouldering mox ([93.35](#93-35))
